...
public class WebDialog extends Dialog {
    ...
    /**
     * Interface that implements a fragments to be called when the user's interaction with the
     ...
     * @param theme      identifier of a theme to pass to the Dialog class
     * @param listener the fragments to notify, or null if no notification is desired
     */
    ...
    /**
     * Sets the fragments which will be notified when the dialog finishes.
     *
     * @param listener the fragments to notify, or null if no notification is desired
     */
    ...
    /**
     * Gets the fragments which will be notified when the dialog finishes.
     *
     * @return the fragments, or null if none has been specified
     */
